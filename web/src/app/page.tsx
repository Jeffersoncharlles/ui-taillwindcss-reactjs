...
export default function Home() {
  return (
     <main className="prose prose-invert prose-headings:text-slate-200 prose-headings:font-semibold prose-h1:text-3xl prose-h2:text-xl prose-h2:font-medium prose-p:text-slate-400 prose-pre:border prose-pre:bg-slate-800 prose-pre:border-white/10 prose-pre:rounded-2xl prose-a:text-cyan-600">
